...
namespace Corrade.Structures
{
    ...
    public class SerializedNotification
    {
        ...
        public Configuration.Notifications Notification
        {
            get; set;
        }

        [XmlElement(ElementName = "NotificationParameters")]
        public SerializableDictionary<string, HashSet<Parameter>> NotificationParameters
        {
            get; set;
        }
        ...
        public class Resolve
        {
            ...
            public ResolveDestination ResolveDestination
            {
                get; set;
            }
        }
        ...
        public class Processing
        {
            ...
            public NameSplit NameSplit
            {
                get; set;
            }

            [XmlElement(ElementName = "IdentifyLanguage")]
            public IdentifyLanguage IdentifyLanguage
            {
                get; set;
            }

            [XmlElement(ElementName = "BayesClassify")]
            public BayesClassify BayesClassify
            {
                get; set;
            }
            ...
            public ToEnumMemberName ToEnumMemberName
            {
                get; set;
            }

            [XmlElement(ElementName = "TernarySubstitution")]
            public TernarySubstitution TernarySubstitution
            {
                get; set;
            }

            [XmlElement(ElementName = "ConditionalSubstitution")]
            public ConditionalSubstitution ConditionalSubstitution
            {
                get; set;
            }
