...
namespace Corrade
{
    public partial class Corrade
    {
        ...
        {
            public static Action<Command.CorradeCommandParameters, Dictionary<string, string>> setprimitivelightdata =
                (corradeCommandParameters, result) =>
                {
                    ...
                    primitive.Light.wasCSVToStructure(Client, corradeConfiguration.ServicesTimeout,
