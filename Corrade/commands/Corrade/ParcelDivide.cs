...
namespace Corrade
{
    public partial class Corrade
    {
        ...
        {
            public static readonly Action<Command.CorradeCommandParameters, Dictionary<string, string>> parceldivide
                =
                (corradeCommandParameters, result) =>
                {
                    ...
                    Client.Parcels.ParcelSubdivide(simulator, x1, y1, x2, y2);
